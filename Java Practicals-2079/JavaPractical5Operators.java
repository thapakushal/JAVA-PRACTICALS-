...
System.out.println("a<b&a++<c=" + (a<b&a++<c));//true & true = true –bitwise AND
System.out.println("The new value of a=" + a);//6, second condition is always checked in bitwise AND even if first is true or false
...
System.out.println("a>b|a++<c=" + (a>b|a++<c));//false | true = true –bitwise OR
System.out.println("The new value of a=" + a);//7, second condition is always checked in bitwise OR even if first is true or false
...
System.out.println("The new value of a=" + a);//8, second condition is checked in logical AND as first is true
...
System.out.println("The new value of a=" + a);//9, second condition is not checked in logical OR as first is true
System.out.println("The value of a=" + (a));// 9 - final value of a i.e. simple assignment operator
...
System.out.println("The new value of a: " + a);
System.out.println("a++ + ++a=" + (a++ + ++a)); //0+ 2 =2
System.out.println("b++ + b++=" + (b++ + b++)); // 10+11=21
System.out.println("!d=" + (!d));//!d=!true=false;
System.out.println("a<<2= " + (a<<2)); //2*2^2=2*4=8
System.out.println("a<<=3 " + (a<<3)); //2*2^3=2*8=16
System.out.println("a>>2=" + (a>>2)); // 2/2^2=2/4= 0
System.out.println("a>>3=" + (a>>3)); // 2/2^3=2/8=0
System.out.println("-a>>2=" + (-a>>2)); //-2/2^2=-2/4=-0
