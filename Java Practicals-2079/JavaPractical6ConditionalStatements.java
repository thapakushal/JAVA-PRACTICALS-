...
// Java Program to Demonstrate If Statement
	int  num=12;  // Defining a variable  
...
// Java Program to Demonstrate If - Else Statement
	...
	int  num1=9;  // Defining a variable  
	if(num1%2==0) // Checking the condition to identify a number is even
	{  
	System.out.print("The number is even");  
	} 
	else
...
// Java Program to Demonstrate Nested - If Statement
	...
	int age=15;  // Declaring a variable for school age
...
// Java Program to Demonstrate Switch - Case Statement
	...
	int day=4; // Declaring a variable for weekday  
	String dayString="";  
